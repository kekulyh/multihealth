			...
			<div class="row">
				...
				<div class="col-md-10 col-sm-10">
					<div class="blog-post blog-single-post">
							...
							<div class="col-md-8 servc-info">
								...
								<div class="panel panel-info" style="height: 300px; overflow: auto">
									...
									<table class="table">
										...
										<tbody>
											<c:forEach var="medicineSearchList" items="${medicineSearchList}">
												<tr>
													<td><a href="<%=request.getContextPath()%>/medication_medicine_single?medicineId=${medicineSearchList.medicineId}&page=1">${medicineSearchList.medicineName}</a></td>
													<td>${medicineSearchList.medicineSymptom}</td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
						...
						<!-- Top Viewd Medicine -->
						<div class="">
							<h3 class="text-center">Top Viewed Medicine</h3>
							<div class="col-md-2"></div>
							<div class="col-md-8 servc-info">
								...
								<div class="panel panel-info">
									...
									<div class="panel-heading">
										<h3 class="panel-title text-center">Top Viewed Medicine</h3>
									</div>
									
									<table class="table">
										<thead>
											<tr>
												<th>Medicine Name</th><th>User Reviews</th>
											</tr>
										</thead>
										<tbody>
											<c:forEach var="medicineCommentCountList" items="${medicineCommentCountList}">
												<tr><td><a href="<%=request.getContextPath()%>/medication_medicine_single?medicineId=${medicineCommentCountList.medicineId}&page=1">${medicineCommentCountList.medicineName}</a></td><td>${medicineCommentCountList.medicineCommentCount}</td></tr>
											</c:forEach>
										</tbody>
									</table>
								</div>
