					...
					<div class="blog-post blog-single-post">
						...
						<div class="">
							...
							<div class="col-md-8 servc-info">
								...
								<form role="form" id="form2" action="medication_events_edit" method="post" enctype="multipart/form-data">
									
									<div class="form-group hide">
									  <input type="text" class="form-control" id="medicationEventsId" name="medicationEventsId" value="${e.medicationEventsId}">
									</div>
									<div class="form-group">
									  <label for="medicationEventsTitle" >Event Title</label>
									  <input type="text" class="form-control" id="medicationEventsTitle" name="medicationEventsTitle" placeholder="Event Title" check-type="required" value="${e.medicationEventsTitle}">
									</div>
									
									<div class="form-group">
									    <label for="medicationEventsContent">Event Content</label>
									    <textarea  class="form-control" id="medicationEventsContent" name="medicationEventsContent" placeholder="Event Content" check-type="required" rows="2">${e.medicationEventsContent}</textarea>
									</div>
									<div class="form-group">
									    <label for="medicationEventsAddress">Event Address</label>
									    <textarea  class="form-control" id="medicationEventsAddress" name="medicationEventsAddress" placeholder="Event Address" check-type="required" rows="2">${e.medicationEventsAddress}</textarea>
									</div>
