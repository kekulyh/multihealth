							...
							<div class="col-md-8 servc-info">
								...
								<div class="panel panel-info" style="height: 300px; overflow: auto">
									...
									<table class="table">
										...
										<tbody>
											<c:forEach var="medicineList" items="${medicineList}">
												<tr><td><a href="<%=request.getContextPath()%>/medication_medicine_single?medicineId=${medicineList.medicineId}&page=1">${medicineList.medicineName}</a></td></tr>
											</c:forEach>
										</tbody>
									</table>
