							...
							<div class="col-md-8 servc-info">
								...
								<div class="panel panel-info" style="height: 300px; overflow: auto">
									...
									<table class="table">
										...
										<tbody>
											<c:forEach var="pharmacyDoctorSearchList" items="${pharmacyDoctorSearchList}">
												<tr>
													<td><a href="<%=request.getContextPath()%>/medication_doctor_single?pharmacyDoctorId=${pharmacyDoctorSearchList.pharmacyDoctorId}&page=1">${pharmacyDoctorSearchList.pharmacyDoctorName}</a></td>
													<td>${pharmacyDoctorSearchList.pharmacyDoctorPharmacy}</td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
