...
<html>
<head>
<title>MultiHealth :: Medication :: User</title>
				...
				<div class="col-md-10 col-sm-10">
					<div class="blog-post blog-single-post">
						...
						<div class="text-center">
							<h3>MultiHealth :: Medication :: User</h3>
						</div>
						...
						<div class="">
							<div class="col-md-6 servc-info">
								<ul>
									...
									<li>
										<a href="medication_medicine_find"><h4>Find a Medicine</h4></a>
							...
							<div class="col-md-6 servc-info">
								<ul>
									<li><img src="images/survivalbag.png" width="50" alt=""></li>
									<li>
										<a href="medication_medicine_list"><h4>View Medicine List</h4></a>
