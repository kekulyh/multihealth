			...
			<div class="row">
				...
				<div class="col-md-10 col-sm-10">
					<div class="blog-post blog-single-post">
						...
						<!-- Find Doctor -->
						<div class="">
							<h3 class="text-center">Pharmacy Doctor List</h3>
							...
							<div class="col-md-8 servc-info">
								...
								<div class="panel panel-info" style="height: 300px; overflow: auto">
									<div class="panel-heading">
										<h3 class="panel-title text-center">Pharmacy Doctor List</h3>
									</div>
									...
									<table class="table">
										...
										<tbody>
											<c:forEach var="pharmacyDoctorList" items="${pharmacyDoctorList}">
												<tr>
													<td><a href="<%=request.getContextPath()%>/medication_doctor_single?pharmacyDoctorId=${pharmacyDoctorList.pharmacyDoctorId}&page=1">${pharmacyDoctorList.pharmacyDoctorName}</a></td>
													<td>${pharmacyDoctorList.pharmacyDoctorPharmacy}</td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
