			...
			<div class="row work-row">
				<div class="col-sm-6 col-md-4 work-row-grids">
					<div class="work-grids-img">
						<img src="images/add5.png" alt="" width="64px" height="64px"/>
					</div>	
					<div class="caption work-captn">
						<h4><a href="jumptimetable">Add Timetable</a></h4>
						<p>Please Upload Your Timetible here</p>						
					 </div>
				</div>
				<div class="col-sm-6 col-md-4 work-row-grids">
					<div class="work-grids-img">
						<img src="images/file123.jpg" width="64px" height="64px"/>
					</div>	
					<div class="caption work-captn">
						<h4><a href="userapp">Check The Appointment</a></h4>
						<p>Check Your Appointment Here</p>						
					 </div>
				</div>
				<div class="col-sm-6 col-md-4 work-row-grids">
					<div class="work-grids-img">
						<img src="images/fangdada.png" width="64px" height="64px"/>
					</div>	
					<div class="caption work-captn">
						<h4><a href="docinfor">The Problems You Have Solved</a></h4>
						<p>Click Here To Check The Problems You Have Solved</p>						
					 </div>
				</div>
				<div class="clearfix"> </div>
			</div>
