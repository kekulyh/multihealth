					...
					<div class="blog-post blog-single-post">
						...
						<div class="">
							...
							<div class="col-md-8 servc-info">
								...
								<form role="form" id="form2" action="medication_medicine_add" method="post" enctype="multipart/form-data">
									<div class="form-group">
									  <label for="medicineName" >Medicine Name</label>
									  <input type="text" class="form-control" id="medicineName" name="medicineName" placeholder="Medicine Name" check-type="required">
									</div>
									<div class="alert alert-danger alert-dismissable hide" id="medicineExist">
			                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
			                                <span aria-hidden="true">&times;</span>
			                            </button>
			                            <strong>ERROR! This medicine is already exist. You may want to edit it <a href="<%=request.getContextPath()%>/medication_medicine_edit?medicineId=${m.medicineId}">here</a>.</strong>
			                        </div>
									...
									<div class="form-group">
									    ...
									    <textarea  class="form-control" id="medicineSymptom" name="medicineSymptom" placeholder="Medicine Symptom" check-type="required" rows="1"></textarea>
									</div>
									<div class="form-group">
									    <label for="medicineUsage">Medicine Usage</label>
									    <textarea  class="form-control" id="medicineUsage" name="medicineUsage" placeholder="Medicine Usage" check-type="required" rows="2"></textarea>
									</div>
									<div class="form-group">
									    <label for="medicineSymptom">Medicine Side Effect</label>
									    <textarea  class="form-control" id="medicineSideEffect" name="medicineSideEffect" placeholder="Medicine Side Effect" check-type="required" rows="2"></textarea>
									</div>
									<div class="form-group">
									    <label for="medicineSymptom">Medicine Overdose Effect</label>
									    <textarea  class="form-control" id="medicineOverdoseEffect" name="medicineOverdoseEffect" placeholder="Medicine Overdose Effect" check-type="required" rows="2"></textarea>
									</div>
									<div class="form-group">
									    <label for="medicineSymptom">Medicine Precaution</label>
									    <textarea  class="form-control" id="medicinePrecaution" name="medicinePrecaution" placeholder="Medicine Precaution" check-type="required" rows="2"></textarea>
									</div>
