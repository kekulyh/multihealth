...
<html>
<head>
<title>MultiHealth:: Mantel</title>
		...
		<div class="container">
			...
			<div class="about-text">
				...
				<div class="container">
					...
					<form class="form-horizontal" id="form1" action="${pageContext.request.contextPath}/upload2" role="form" enctype="multipart/form-data" method="post">
