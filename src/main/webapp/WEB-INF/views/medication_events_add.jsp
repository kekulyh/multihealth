					...
					<div class="blog-post blog-single-post">
						...
						<div class="">
							...
							<div class="col-md-8 servc-info">
								...
								<form role="form" id="form2" action="medication_events_add" method="post" enctype="multipart/form-data">
									<div class="form-group">
									  <label for="medicationEventsTitle" >Event Title</label>
									  <input type="text" class="form-control" id="medicationEventsTitle" name="medicationEventsTitle" placeholder="Event Title" check-type="required">
									</div>
									<div class="alert alert-danger alert-dismissable hide" id="medicationEventsExist">
			                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
			                                <span aria-hidden="true">&times;</span>
			                            </button>
			                            <strong>ERROR! This event is already exist. You may want to edit it <a href="<%=request.getContextPath()%>/medication_events_edit?medicationEventsId=${e.medicationEventsId}">here</a>.</strong>
			                        </div>
									...
									<div class="form-group">
									    <label for="medicationEventsContent">Event Content</label>
									    <textarea  class="form-control" id="medicationEventsContent" name="medicationEventsContent" placeholder="Event Content" check-type="required" rows="2"></textarea>
									</div>
									<div class="form-group">
									    <label for="medicationEventsAddress">Event Address</label>
									    <textarea  class="form-control" id="medicationEventsAddress" name="medicationEventsAddress" placeholder="Event Address" check-type="required" rows="2"></textarea>
									</div>
									
									<div class="form-group ">
										<label for="medicationEventsImage">Upload Event Image</label>
										<input id="medicationEventsImage" multiple type="file" class="file-loading" accept="image/*" name="medicationEventsImage">
										<script>
										$("#medicationEventsImage").fileinput({
										    maxFileCount: 4,
										...
										<p class="help-block">Upload the image of event.</p>
									</div>
