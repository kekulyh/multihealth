			...
			<div class="row">
				...
				<div class="col-md-10 col-sm-10">
					<div class="blog-post blog-single-post">
						...
						<!-- Latest News -->
						<h3 class="text-center">Events :: Lectures :: Seminars</h3>
						<br>
						
						<!-- Events -->
						<c:forEach var="medicationEventsList" items="${medicationEventsList}">
							<div class="col-md-6 col-sm-6">
								<div class="portfolio-item">
									<div class="portfolio-image">
										<%-- <a href="<%=request.getContextPath()%>/medication_events_single?eventId=${medicationEventsList.medicationEventsId}"> --%><img src="images/portfolio1.jpg" alt="Project Name"></a>
									</div>
									<div class="portfolio-info">
										<ul>
											<li class="portfolio-project-name">${medicationEventsList.medicationEventsTitle}</li>
											<li>${medicationEventsList.medicationEventsDate}</li>
											<li>${medicationEventsList.medicationEventsAddress}</li>
											<%-- <li class="read-more"><a href="<%=request.getContextPath()%>/medication_events_single?eventId=${medicationEventsList.medicationEventsId}" class="btn">Read more</a></li> --%>
										</ul>
									</div>
						...
						<%-- <c:forEach var="medicationNewsList" items="${medicationNewsList}">
							<div class="medicationnews-info">
								<div class="col-md-12 medicationnews-grids">
									<div class="medicationnews-grids-left">
										<img src="images/img13.jpg" height="" alt="" title=""/>
									</div>
									<div class="medicationnews-grids-right">
										<h5>${medicationNewsList.medicationNewsDate}</h5>
										<h4><a href="<%=request.getContextPath()%>/medication_news_single?medicationNewsId=${medicationNewsList.medicationNewsId}">${medicationNewsList.medicationNewsTitle}</a></h4>
										<p class="newsContent">${medicationNewsList.medicationNewsContent}</p>
									</div>
									<div class="clearfix"> </div>
								</div>
								<div class="clearfix"> </div>
						...
						<!-- display first 500 char of the news -->
						<script>
						    var newsContent = document.getElementsByClassName('newsContent');
						    
						    for (var i=0;i<newsContent.length;i++) {
						    	
						    	var allContent = newsContent[i].innerHTML;
						    	newsContent[i].innerHTML = allContent.substr(0,500)+" ...";
						    	
						    }
						</script>
						<!-- display first 500 char of the news end --> --%>
						...
						<div class="pagination-wrapper ">
							<ul class="pagination pagination-sm">
								...
								<c:forEach var="paginationList" items="${paginationList}">
									...
									<li id="previousPage"><a href="medication_events_page?page=${paginationList.currentPage-1}">Previous</a></li>
									
									<c:forEach var="i" begin="1" end="${paginationList.maxPage}">
										<li id="page${i}"><a href="medication_events_page?page=${i}">${i}</a></li>
									</c:forEach>
									
									<li id="nextPage"><a href="medication_events_page?page=${paginationList.currentPage+1}">Next</a></li>
