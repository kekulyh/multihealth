					...
					<div class="blog-post blog-single-post">
						...
						<div class="">
							...
							<div class="col-md-8 servc-info">
								...
								<form role="form" id="form2" action="medication_news_edit" method="post" enctype="multipart/form-data">
									
									<div class="form-group hide">
									  <input type="text" class="form-control" id="medicationNewsId" name="medicationNewsId" value="${n.medicationNewsId}">
									</div>
									<div class="form-group">
									  <label for="medicationNewsTitle" >News Title</label>
									  <input type="text" class="form-control" id="medicationNewsTitle" name="medicationNewsTitle" placeholder="News Title" check-type="required" value="${n.medicationNewsTitle}">
									</div>
									
									<div class="form-group">
									    <label for="medicationNewsAuthor">News Author</label>
									    <textarea  class="form-control" id="medicationNewsAuthor" name="medicationNewsAuthor" placeholder="News Author" check-type="required" rows="2">${n.medicationNewsAuthor}</textarea>
									</div>
									<div class="form-group">
									    <label for="medicationNewsContent">News Content</label>
									    <textarea  class="form-control" id="medicationNewsContent" name="medicationNewsContent" placeholder="News Content" check-type="required" rows="2">${n.medicationNewsContent}</textarea>
									</div>
