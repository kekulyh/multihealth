						...
						<div class="">
							...
							<div class="col-md-10 servc-info">
								...
								<div class="comment-form-wrapper">
									<label><i class="glyphicon glyphicon-plus"></i> <a href="medication_medicine_add">Add Medicine</a></label>&nbsp;&nbsp;&nbsp;&nbsp;
									<!-- <label><i class="glyphicon glyphicon-remove"></i> <a href="medication_medicine_add">Bulk Remove Medicine</a></label> -->
								</div>
								<!-- manage control end -->
								...
								<div class="panel panel-info" style="height: 300px; overflow: auto">
									<div class="panel-heading">
										<h3 class="panel-title text-center">Medicine List</h3>
									</div>
									...
									<table class="table">
										<thead>
											<tr>
												...
												<th>Medicine Name</th>
												<th>Medicine Editor</th>
												<th>Medicine Edit Date</th>
												<th class="text-center">Edit</th>
											</tr>
										</thead>
										<tbody>
											<c:forEach var="medicineManageList" items="${medicineManageList}">
												<tr>
													<td>
														<label>
														    <input type="checkbox" name="subcheck" value="${medicineManageList.medicineId}">
														</label>
													</td>
													<td>${medicineManageList.medicineName}</td>
													<td>${medicineManageList.medicineEditor}</td>
													<td>${medicineManageList.medicineEditDate}</td>
													<td class="text-center"><i class="glyphicon glyphicon-pencil"></i><a href="<%=request.getContextPath()%>/medication_medicine_edit?medicineId=${medicineManageList.medicineId}"> Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;<i class="glyphicon glyphicon-remove"></i><a href="javascript:void(0)" onclick="dodel(${medicineManageList.medicineId})" data-toggle="modal" data-target="#myModal" id="modal${medicineManageList.medicineId}"> Remove</a></td>
												</tr>
												
												<script type="text/javascript">
												function dodel(id){
													$(".btn-primary").attr('href','<%=request.getContextPath()%>/medication_medicine_delete?medicineId='+id);
												}
												</script>
