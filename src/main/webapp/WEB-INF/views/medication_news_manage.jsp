						...
						<div class="">
							...
							<div class="col-md-10 servc-info">
								...
								<div class="comment-form-wrapper">
									<label><i class="glyphicon glyphicon-plus"></i> <a href="medication_news_add">Add News</a></label>&nbsp;&nbsp;&nbsp;&nbsp;
									<!-- <label><i class="glyphicon glyphicon-remove"></i> <a href="medication_news_add">Bulk Remove News</a></label> -->
								</div>
								<!-- manage control end -->
								...
								<div class="panel panel-info" style="height: 300px; overflow: auto">
									<div class="panel-heading">
										<h3 class="panel-title text-center">News List</h3>
									</div>
									...
									<table class="table">
										<thead>
											<tr>
												...
												<th>News Title</th>
												<th>News Editor</th>
												<th>News Edit Date</th>
												<th class="text-center">Edit</th>
											</tr>
										</thead>
										<tbody>
											<c:forEach var="medicationNewsManageList" items="${medicationNewsManageList}">
												<tr>
													<td>
														<label>
														    <input type="checkbox" name="subcheck" value="${medicationNewsManageList.medicationNewsId}">
														</label>
													</td>
													<td width="40%">${medicationNewsManageList.medicationNewsTitle}</td>
													<td width="15%">${medicationNewsManageList.medicationNewsEditor}</td>
													<td width="20%">${medicationNewsManageList.medicationNewsEditDate}</td>
													<td class="text-center" width="25%"><i class="glyphicon glyphicon-pencil"></i><a href="<%=request.getContextPath()%>/medication_news_edit?medicationNewsId=${medicationNewsManageList.medicationNewsId}"> Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;<i class="glyphicon glyphicon-remove"></i><a href="javascript:void(0)" onclick="dodel(${medicationNewsManageList.medicationNewsId})" data-toggle="modal" data-target="#myModal" id="modal${medicationNewsManageList.medicationNewsId}"> Remove</a></td>
												</tr>
												
												<script type="text/javascript">
												function dodel(id){
													$(".btn-primary").attr('href','<%=request.getContextPath()%>/medication_news_delete?medicationNewsId='+id);
												}
												</script>
