						...
						<div class="pagination-wrapper ">
							<ul class="pagination pagination-sm">
								...
								<c:forEach var="paginationList" items="${paginationList}">
									...
									<li id="previousPage"><a href="medication_news_page?page=${paginationList.currentPage-1}">Previous</a></li>
									
									<c:forEach var="i" begin="1" end="${paginationList.maxPage}">
										<li id="page${i}"><a href="medication_news_page?page=${i}">${i}</a></li>
									</c:forEach>
									
									<li id="nextPage"><a href="medication_news_page?page=${paginationList.currentPage+1}">Next</a></li>
