				...
				<div class="post-comments">
							...
							<div class="comment-wrapper">
								<div class="comment-author">
									<img src="${ comm.doctor.attachment}" alt="User Pic">${comm.doctor.name }
								</div>
								<div class="comment-action">
									...
									<div align="right">
										<span class="comment-date">${comm.doccondate}</span> <a
									...
									<div class="collapse" id="collapseExample">
										<div class="well">
											<div class="clearfix"></div>
											<form action="addconcomm1" method="post" id="form1"
												name="form1">
							...
							<table class="table">
								<tbody>
									<tr>
										<td width="200px"><div class="col-sm-4">
												<img class="img-circle" alt="40x40"
													src="${ comm.user.attachment}" width="50px" height="50px">
