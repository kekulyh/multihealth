						...
						<table
							...
							<tbody>
								...
								<c:forEach var="time" items="${timetables }">
									...
									<td class="center">${time.timePeriod }</td>
									<td class="center">${time.address }</td>
									<td class="center">${time.tstate }</td>
									<td class="center"> <a class="btn btn-info" href="<%=request.getContextPath() %>/reservedate?tid=${time.id}"> <i
