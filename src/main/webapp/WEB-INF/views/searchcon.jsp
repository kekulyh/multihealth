...
<html>
<head>
<title>MultiHealth:: Mental</title><link href="css/bootstrap.css" type="text/css" rel="stylesheet"
	media="all">
		...
		<div class="col-md-3 col-sm-3 blog-sidebar">
					...
					<form role="form" action="consultsearch" method="post">
						<div class="input-group">
							<input type="text" class="form-control input-sm" id="medicineSearchSidebar" placeholder="Name" name="findconsult">
		...
		<div class="text-center">
					...
					<div class="panel panel-info" style="height: 300px; weight:1000px;overflow:auto">
						...
						<table
							...
							<tbody>
								<tr>
								<c:forEach var="list" items="${consultlist }">
									<td>${list.title }</td>
