			...
			<div class="row">
				...
				<div class="col-md-10 col-sm-10">
					<div class="blog-post blog-single-post">
						...
						<!-- Medicine List -->
						<div class="">
							<h3 class="text-center">Edit Medicine</h3>
							...
							<div class="col-md-8 servc-info">
								...
								<form role="form" id="form2" action="medication_medicine_edit" method="post" enctype="multipart/form-data">
									
									<div class="form-group hide">
									  
									  <input type="text" class="form-control" id="medicineId" name="medicineId"  value="${m.medicineId}">
									</div>
									<div class="form-group">
									  <label for="medicineName" >Medicine Name</label>
									  <input type="text" class="form-control" id="medicineName" name="medicineName" placeholder="Medicine Name" check-type="required" value="${m.medicineName}">
									</div>
									<div class="form-group">
									    <label for="medicineSymptom">Medicine Symptom</label>
									    <textarea  class="form-control" id="medicineSymptom" name="medicineSymptom" placeholder="Medicine Symptom" check-type="required" rows="1" >${m.medicineSymptom}</textarea>
									</div>
									<div class="form-group">
									    <label for="medicineUsage">Medicine Usage</label>
									    <textarea  class="form-control" id="medicineUsage" name="medicineUsage" placeholder="Medicine Usage" check-type="required" rows="2">${m.medicineUsage}</textarea>
									</div>
									<div class="form-group">
									    <label for="medicineSymptom">Medicine Side Effect</label>
									    <textarea  class="form-control" id="medicineSideEffect" name="medicineSideEffect" placeholder="Medicine Side Effect" check-type="required" rows="2">${m.medicineSideEffect}</textarea>
									</div>
									<div class="form-group">
									    <label for="medicineSymptom">Medicine Overdose Effect</label>
									    <textarea  class="form-control" id="medicineOverdoseEffect" name="medicineOverdoseEffect" placeholder="Medicine Overdose Effect" check-type="required" rows="2">${m.medicineOverdoseEffect}</textarea>
									</div>
									<div class="form-group">
									    <label for="medicineSymptom">Medicine Precaution</label>
									    <textarea  class="form-control" id="medicinePrecaution" name="medicinePrecaution" placeholder="Medicine Precaution" check-type="required" rows="2">${m.medicinePrecaution}</textarea>
									</div>
									
									<div class="form-group ">
										<label for="medicineImage">Upload Medicine Image</label>
										<input id="medicineImage" multiple type="file" class="file-loading" accept="image/*" name="medicineImage">
										<script>
