...
<body>
	...
	<div class="section">
		...
		<form action="returnindex2" method="post">
		<div class="col-md-9 col-sm-9">
		
					<div class="blog-post blog-single-post">
		<div class="text-center">
							<h3>The Reservations From Users</h3>
						</div>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
							...
							<tbody>
								...
								<c:forEach var="alist" items="${alist}">
									<td>${alist.availableDate }</td>
									<td class="center">${alist.timePeriod }</td>
									<td class="center">${alist.address}</td>
									<td class="center">${alist.user.name }</td>
